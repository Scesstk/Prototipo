...
public class reporte_docfecha {
    ...
    String fechah;
     ...
     public void reporteDocFecha(Date f1, Date f2, int entrada, int salida, String doc) throws IOException{

...
ConnectBD.Pconnection con= new ConnectBD.Pconnection();
    ...
    private void initComponents() {
        ...
        titulo.setFont(new java.awt.Font("Freshman", 1, 30)); // NOI18N
        titulo.setForeground(new java.awt.Color(252, 115, 35));
        titulo.setText("S.C.E.S.S");
        titulo.setToolTipText("");
        header.add(titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 0, 160, 40));
